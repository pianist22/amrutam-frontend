...
// // SidebarLink renders parent or child links with conditional highlight and toggle arrow
// const SidebarLink = ({
//   label,
//   icon,
//   href,
...
// }) => {
//   if (isCollapsible) {
//     // Collapsible parent: clickable toggle button with submenu
//     return (
//       <button
//         type="button"
//         onClick={toggle}
...
//   // Non-collapsible: a simple Link with highlight if active
//   return (
//     <Link
//       href={href}
//       onClick={onClick}
//       className={clsx(
//         "flex items-center px-3 py-2 gap-2 rounded-lg transition-colors",
//         isActive
//           ? "bg-gray-200 text-black font-semibold"
//           : "hover:bg-gray-100 text-gray-700"
//       )}
...
//   // Helper to check if path matches or path is child of parent
//   const isLinkActive = (href) => {
//     if (!href) return false;
//     if (href === '/') return pathname === '/';
//     if (pathname === href) return true;
//     // Match especially for parent paths, e.g. /ingredients for /ingredients/...
...
//                           href={child.href}
//                           className={clsx(
//                             "flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-100 text-gray-600 text-sm",
...
//           <button
//             className="fixed top-[88px] z-50 md:hidden bg-white border border-green-100 shadow rounded-full p-2 focus:outline-none "
...
//                             href={child.href}
//                             className={clsx(
//                               "flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-green-50 text-gray-700 text-sm",
//                               activeChild && "bg-green-50 text-green-800 font-semibold"
//                             )}
